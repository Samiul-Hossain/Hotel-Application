    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nameMap.put("Arrival Date",myArrival);
                nameMap.put("Number of Rooms",myRoom);
                nameMap.put("Number of Adults",myAdult);
                nameMap.put("Number of Kids",myKids);
                nameMap.put("Name of Customer",myName);
                nameMap.put("Number of Customer",myNumber);
                ...
                mReference.push().setValue(nameMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(Reservation.this, "BOOKING SUCCESSFUL!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
